...
$(function () {
  ...
  $('.blog-slider-for').slick("slickAdd", compiled, 0, true);
  $('.blog-slider-for').slick('reinit');

  $('.blog-slider-nav').slick("slickAdd", compiled, 0, true);
  $('.blog-slider-nav').slick('reinit');
});
