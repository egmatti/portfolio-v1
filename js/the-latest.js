...
$(function () {
  var source = $("#blog-post-partial").html();
  var content = $($.parseHTML(response));
  var template = Handlebars.compile(content.filter(("#blog-post-partial").html());

  Handlebars.registerPartial({
    blogFor: content.filter("#blog-slider-for-partial").html(),
    blogNav: content.filter("#blog-slider-nav-partial").html()
  });
  ...
  $('#the-latest-page .blog-list').innerHTML(compiled);
